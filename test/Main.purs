  ...
  launchAff_ $ runSpec [consoleReporter] do
    ...
    describe "annotate" do
      ...
      it "should annotate multiple lines with context above" do
        let cfg = defaultConfig (characterLocation 2 2) # withContextAbove 1
        annotate cfg "line 1\nline 2\nline 3"
          `shouldEqual` "1: line 1\n2: line 2\n    ^-----"

      it "should annotate multiple lines with context below" do
        let cfg = defaultConfig (characterLocation 2 2) # withContextBelow 1
        annotate cfg "line 1\nline 2\nline 3"
          `shouldEqual` "2: line 2\n    ^-----\n3: line 3"

      it "should annotate multiple lines with context above and below" do
        let cfg = defaultConfig (characterLocation 2 2) # withContextAbove 1 # withContextBelow 1
        annotate cfg "line 1\nline 2\nline 3"
          `shouldEqual` "1: line 1\n2: line 2\n    ^-----\n3: line 3"

      it "should annotate multiple lines with context left" do
        let cfg = defaultConfig (characterLocation 2 4) # withContextLeft 2
        annotate cfg "line 1\nline 2\nline 3"
          `shouldEqual` "2: ine 2\n-----^"

      it "should annotate multiple lines with context right" do
        let cfg = defaultConfig (characterLocation 2 4) # withContextRight 2
        annotate cfg "line 1\nline 2 with additional content\nline 3"
          `shouldEqual` "2: line 2\n -----^"

      it "should annotate multiple lines with context right and left" do
        let cfg = defaultConfig (characterLocation 2 4) # withContextLeft 2 # withContextRight 2
        annotate cfg "line 1\nline 2 with additional content\nline 3"
          `shouldEqual` "2: ine 2\n-----^"

      it "should annotate multiple lines with context right, left, above and below" do
        let cfg = defaultConfig (characterLocation 2 4) # withContextLeft 2 # withContextRight 2 # withContextAbove 1 # withContextBelow 1
        annotate cfg "line 1\nline 2 with additional content\nline 3"
          `shouldEqual` "1: ine 1\n2: ine 2\n-----^\n3: ine 3"
